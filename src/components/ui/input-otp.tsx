  ...
  return (
    <div
      ...
      className={cn(
        ...
        dark:has-aria-invalid:ring-destructive/40 flex items-center rounded-lg
  ...
  return (
    <div
      ...
      className={cn(
        ...
        size-8 items-center justify-center border-y border-r text-sm
        transition-all outline-none first:rounded-l-lg first:border-l
        last:rounded-r-lg data-[active=true]:z-10 data-[active=true]:ring-3`,
        className,
      )}
      {...props}
    >
