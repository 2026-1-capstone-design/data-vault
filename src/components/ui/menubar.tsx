...
const MenubarTrigger = ({
  ...
  return (
    <MenubarPrimitive.Trigger
      ...
      className={cn(
        `hover:bg-muted aria-expanded:bg-muted flex items-center rounded-sm
        px-1.5 py-[2px] text-sm font-medium outline-hidden select-none`,
        className,
      )}
      {...props}
    />
    ...
    <MenubarPortal>
      <MenubarPrimitive.Content
        ...
        className={cn(
          ...
          data-open:fade-in-0 data-open:zoom-in-95 z-50 min-w-36
  ...
  return (
    <MenubarPrimitive.CheckboxItem
      ...
      className={cn(
        ...
        items-center gap-1.5 rounded-md py-1 pr-1.5 pl-7 text-sm outline-hidden
        select-none data-disabled:pointer-events-none data-inset:pl-7
    ...
    >
      <span
        className="pointer-events-none absolute left-1.5 flex size-4
          items-center justify-center [&_svg:not([class*='size-'])]:size-4"
      >
  ...
  return (
    <MenubarPrimitive.SubTrigger
      ...
      className={cn(
        ...
        gap-1.5 rounded-md px-1.5 py-1 text-sm outline-none select-none
  ...
  return (
    <MenubarPrimitive.SubContent
      ...
      className={cn(
        ...
        data-closed:fade-out-0 data-closed:zoom-out-95 z-50 min-w-32
        origin-(--radix-menubar-content-transform-origin) overflow-hidden
