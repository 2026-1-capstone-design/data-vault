...
const ItemTitle = ({ className, ...props }: React.ComponentProps<"div">) => {
  return (
    <div
      ...
      className={cn(
        `font-heading line-clamp-1 flex w-fit items-center gap-2 text-sm
        leading-snug font-medium underline-offset-4`,
        className,
      )}
      {...props}
    />
  ...
  return (
    <p
      ...
      className={cn(
        ...
        text-sm leading-normal font-normal group-data-[size=xs]/item:text-xs
