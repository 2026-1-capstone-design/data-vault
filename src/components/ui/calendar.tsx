    ...
    <DayPicker
      ...
      classNames={{
        ...
        caption_label: cn(
          ...
          captionLayout === "label"
            ? "text-sm"
            : `[&>svg]:text-muted-foreground flex items-center gap-1
        ...
        range_start: cn(
          `bg-muted after:bg-muted relative isolate z-0
          rounded-l-(--cell-radius) after:absolute after:inset-y-0 after:right-0
          after:w-4`,
        ...
        range_end: cn(
          `bg-muted after:bg-muted relative isolate z-0
          rounded-r-(--cell-radius) after:absolute after:inset-y-0 after:left-0
          after:w-4`,
